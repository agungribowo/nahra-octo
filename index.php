...
<body>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-md-5 d-none d-lg-block">
                        ...
                        <div class="hero__frame">
                            <img class="img-fluid hero__frame-circle" src="assets/img/circul-1.png"
                                alt="circle image">
                            <img class="img-fluid hero__frame-person" src="assets/img/header-img-2.png" alt="image">

                            <img class="hero__frame-lines" src="assets/img/line.svg" alt="image">
                            <div class="hero__frame-team">
                                <h5 class="hero__frame-team--text global__text">Join our volunteers</h5>
                                <div class="hero__four-frame--users">
                                    <img class="hero__four-frame--users---img1" src="assets/img/user-frame-1.png"
                                        alt="image">
                                    <img class="" src="assets/img/user-frame-2.png" alt="image">
                                    <img class="hero__four-frame--users---img3" src="assets/img/user-frame-3.png"
                                        alt="image">
                                    <div class="">
    ...
    <div class="donation global__py">
        <div class="container p-sm-0">
            <div class="row align-items-center">
                <div class="col-6 d-none d-lg-block" data-aos="fade-right" data-aos-duration="1000">
                    <div class="donation__img donation__img-m">
                        <img class="donation__img-circle" src="assets/img/circul-2.png" alt="circle image">
                        <img class="img-fluid donation__img-person" src="assets/img/add-img.png" alt="image">
                    </div>
                </div>
    ...
    <!-- Service START  -->
    <div class="service service__bg global__py">
        <div class="container p-sm-0">
            <div class="row">
                ...
                <div class="cases__slider">
                    ...
                    <div class="card cases__card">
                        ...
                        <div class="card-body px-4">
                            ...
                            <div class="cases__card-range">
                                <p class="global__desc m-0">Founded: 30.20%</p>
                                <div class="progress cases__card-progress">
                                    <div class="progress-bar cases__card-progress--bar" role="progressbar"
                                        style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                                <div class="cases__card-range--bottom">
                                    <div class="d-flex align-items-center cases__card-range--bottom---m gap-2">
                    ...
                    <div class="card cases__card">
                        ...
                        <div class="card-body px-4">
                            ...
                            <div class="cases__card-range">
                                <p class="global__desc m-0">Founded: 50.80%</p>
                                <div class="progress cases__card-progress">
                                    <div class="progress-bar cases__card-progress--bar" role="progressbar"
                    ...
                    <div class="card cases__card">
                        ...
                        <div class="card-body px-4">
                            ...
                            <div class="cases__card-range">
                                <p class="global__desc m-0">Founded: 60.6%</p>
                                <div class="progress cases__card-progress">
                                    <div class="progress-bar cases__card-progress--bar" role="progressbar"
                    ...
                    <div class="card cases__card">
                        ...
                        <div class="card-body px-4">
                            ...
                            <div class="cases__card-range">
                                <p class="global__desc m-0">Founded: 80.40%</p>
                                <div class="progress cases__card-progress">
                                    <div class="progress-bar cases__card-progress--bar" role="progressbar"
    ...
    <div class="testimonial">
        <div class="">
            ...
            <div class="testimonial__body">
                <div class="testimonial__body-slider2">
                    <div class="">
        ...
        <div class="container p-sm-0">
            ...
            <div class="team__grid">
                ...
                <div class="team__card">
                    ...
                    <div class="">
                        <a href="home-1.html#" class="team__user">Leslie Alexander</a>
                ...
                <div class="team__card">
                    ...
                    <div class="">
                        <a href="home-1.html#" class="team__user">Marilyn Ramirez</a>
                        <p class="team__cate">Volunteer</p>
                    </div>
                </div>
                <!-- User 03 -->
                <div class="team__card">
                    ...
                    <div class="">
                        <a href="home-1.html#" class="team__user">Dianne Russell</a>
                        <p class="team__cate">Volunteer</p>
                    </div>
                </div>
                <!-- User 04 -->
                <div class="team__card">
                    ...
                    <div class="">
                        <a href="home-1.html#" class="team__user">Jenny Wilson</a>
                        <p class="team__cate">Volunteer</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container p-sm-0">
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-md-6 col-xl-4 mt-md-5 mt-xl-0">
                    ...
                    <form action="home-1.html#" method="POST" class="d-flex position-relative">
